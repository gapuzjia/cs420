error id: scala/collection/StrictOptimizedIterableOps#map().
file:///C:/Users/Jia%20Gapuz/Desktop/cs420-1/StreamOperation.scala
empty definition using pc, found symbol in pc: 
found definition using semanticdb; symbol scala/collection/StrictOptimizedIterableOps#map().
empty definition using fallback
non-local guesses:

offset: 10053
uri: file:///C:/Users/Jia%20Gapuz/Desktop/cs420-1/StreamOperation.scala
text:
```scala
...
class StreamOperation() {
  ...
  def maxOfAllElements_s : Option[Int] = {
    ...
    return Some(numbers_2d.flatten.max)
  }
